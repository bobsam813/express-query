...
/***/ function(module, exports, __webpack_require__) {
	...
	var EBusinessID = '1266338';
	var RequestType = '1002';
	var DataType = '2';
	var APP_KEY = '2b0f4caf-0eb5-4ab1-84c9-c9111ac9ac55';
	...
	function request(config) {
		...
		var oUrl = url.parse(reqUrl);
		var protocol = oUrl.protocol || 'http:';
		var hostname = oUrl.hostname;
		var path = oUrl.path;
		var method = config.type.toLowerCase() || 'GET';
		...
		var sData = querystring.stringify(config.data);

		var req = http.request(oReqOptions, function (res) {
	...
	function getLogisticsMsg(config) {
		var sApi = 'http://api.kdniao.cc/Ebusiness/EbusinessOrderHandle.aspx';
		var oData = config.data;
		var oEncodeRequestData = querystring.escape(JSON.stringify(oData));
		var DataMD5 = Utils.md5(JSON.stringify(oData) + APP_KEY);
		var DataSign = Utils.base64(DataMD5);
		var oReqData = { RequestData: oEncodeRequestData, EBusinessID: EBusinessID, RequestType: RequestType, DataSign: DataSign, DataType: DataType };
		var sData = querystring.stringify(oReqData);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _electron = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Child = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\Child.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Child.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Child.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
